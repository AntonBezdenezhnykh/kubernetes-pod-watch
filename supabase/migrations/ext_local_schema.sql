...
-- Run: psql $DATABASE_URL -f supabase/migrations/ext_local_schema.sql
-- Or: psql -h $DB_HOST -p ${DB_PORT:-5432} -U $DB_USER -d $DB_NAME -f supabase/migrations/ext_local_schema.sql
