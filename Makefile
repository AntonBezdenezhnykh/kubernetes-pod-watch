...
REQUIRED_VARS := APP_NAMESPACE APP_NAME APP_VERSION APP_IMAGE APP_REPLICAS CONTAINER_PORT SERVICE_PORT SERVICE_TYPE COLLECT_SCHEDULE LOG_TAIL_LINES TARGET_NAMESPACE DB_HOST DB_PORT DB_NAME DB_USER DB_PASSWORD DB_SSL
